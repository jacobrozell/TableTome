...
public struct GameSystemPlayContext: Sendable, Equatable {
    ...
    public var usesGuidedBattleTracker: Bool {
        capabilities.showsActivationBar || capabilities.resolvesWh40kRules
    }

    /// Toolbar / sheet title for a single unit's rules reference.
    public var unitRulesDetailTitle: String {
        if capabilities.resolvesWh40kRules { return String(localized: "Unit details") }
        if capabilities.showsActivationBar { return String(localized: "Unit card") }
    ...
    public var armyUnitRosterLinkTitle: String {
        if capabilities.showsBattleTacticDecks { return String(localized: "View unit rules cards") }
    ...
    public var unitReferenceLinkTitle: String {
        if capabilities.resolvesWh40kRules { return String(localized: "Units & abilities") }
        if capabilities.showsActivationBar { return String(localized: "Unit cards & abilities") }
        return String(localized: "Unit rules cards & abilities")
    }

    public var unitFocusAccessibilityHint: String {
        if capabilities.resolvesWh40kRules { return String(localized: "Opens unit focus with unit details.") }
        if capabilities.showsActivationBar { return String(localized: "Opens unit focus with unit card details.") }
        return String(localized: "Opens unit focus with unit rules and combat options.")
    }

    public var armyTabBrowseRulesHint: String {
        if capabilities.showsActivationBar {
            return String(localized: "During the battle: track unit health and browse unit cards here.")
        }
        if capabilities.resolvesWh40kRules {
    ...
    public func unitRulesInfoAccessibilityLabel(unitName: String) -> String {
        if capabilities.resolvesWh40kRules { return String(localized: "View \(unitName) unit details") }
        if capabilities.showsActivationBar { return String(localized: "View \(unitName) unit card") }
    ...
    public var catalogHealthValueLabel: String {
        if capabilities.resolvesWh40kRules { return String(localized: "Bundled value") }
        if capabilities.showsActivationBar { return String(localized: "Unit card") }
        return String(localized: "Spearhead app")
    }

    public var useCatalogHealthValueLabel: String {
        if capabilities.resolvesWh40kRules { return String(localized: "Use bundled value") }
        if capabilities.showsActivationBar { return String(localized: "Use unit card value") }
