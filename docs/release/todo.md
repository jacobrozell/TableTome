...
- [ ] **Release surface defaults** — Spearhead + 40k 11e + Combat Patrol (10e) + **Paints**; no Lists/StarCraft/Q&A
...
## TestFlight upload (build 11)

- [x] **Bump build** — `CURRENT_PROJECT_VERSION` → 11 in `project.yml`
...
- [ ] **Archive + upload** — Release notes: [`testflight-1.0.0-build-11.md`](testflight-1.0.0-build-11.md)
