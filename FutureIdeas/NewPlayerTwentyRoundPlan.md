...
**Status:** Rounds 1–10 in progress (June 2026)  
...
Fresh install → ≤3 onboarding screens → one obvious Play CTA → Rules look-up from setup → optional Models nudge after first game.
