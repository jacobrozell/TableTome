# Play Engine Architecture Refactor

**Status:** Phase P1–P3 implemented (2026-06-17). P4–P5 remain.  
**Canonical spec:** [specs/PlayEngineArchitectureSpec.md](../specs/PlayEngineArchitectureSpec.md)
...
## Verification (when promoted)

| Field | Value |
|-------|-------|
| Target release | Pre–Kill Team / Blood Bowl |
| Code paths | `Domain/Registry/`, `Data/JSON/BundledGameSystemRegistry.swift`, `App/AppDependencies.swift` |
| Test | `GameSystemRegistryTests`, existing guided-match UI tests unchanged |
